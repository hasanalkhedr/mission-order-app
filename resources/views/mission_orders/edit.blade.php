    ...
    <form id="mainForm" action="{{ route('mission_orders.update', $missionOrder->id) }}" method="POST" class="w-full">
        ...
        <div class="flex flex-wrap -mx-3 mb-0 w-full">
            <div class="w-1/4 pr-1 pl-3">
                ...
                <x-text-input required name="departure_location" id="departure_location" value="{{ old('departure_location', $missionOrder->departure_location) }}" onblur="returnLocationValue();" />
            </div>
            <div class="w-1/4 px-1">
                <x-label>Lieu de mission<span class="text-red-500">*</span></x-label>
                <x-text-input required name="arrive_location" id="arrive_location" value="{{ old('arrive_location', $missionOrder->arrive_location) }}"  onblur="endMissionLocationValue();" />
            </div>
            <div class="w-1/4 px-1">
        ...
        <div class="flex flex-wrap -mx-3 mb-2 w-full">
            <div class="w-1/4 pr-1 pl-3">
                <x-label>Lieu de mission<span class="text-red-500">*</span></x-label>
                <x-text-input required name="endMission_location" id="endMission_location" value="{{ old('endMission_location', $missionOrder->endMission_location) }}"/>
            </div>
            <div class="w-1/4 px-1">
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <div class="w-full px-3 py-1">
                ...
                <input required @checked(old('repas', $missionOrder->repas) == 1) type="radio" value="1" name="repas"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border border-blue-700 focus:ring-blue-500 dark:focus:ring-blue-600 mr-0 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label class="ms-1 text-sm font-medium mr-5 text-blue-400 dark:text-gray-500">OUI</label>
                <input required @checked(old('repas', $missionOrder->repas) == 0) type="radio" value="0" name="repas"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border border-blue-700 focus:ring-blue-500 dark:focus:ring-blue-600 mr-0 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label class="ms-1 text-sm font-medium text-blue-400 dark:text-gray-500 mr-5">NON</label>
            </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full px-3">
                <div class="flex justify-center items-center p-6 space-x-2 rounded-b border-t border-gray-200">
                    ...
                    <div>
                        <button class="text-blue-700 bg-white-700 hover:bg-white-800focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-md w-48 px-5 py-2.5 text-center border border-gray-200"
