        ...
        <div class="report-page" style="width: 210mm; height: 290mm; margin: 0 auto; padding: 8mm; box-sizing: border-box;">
            ...
            <div class="flex justify-between items-start mb-2">
                ...
                <div class="text-right">
                    <p>New Delhi, {{ $missionOrder->memor_date ? $missionOrder->memor_date->format('d/m/Y') : $missionOrder->end_date->format('d/m/Y') }}</p>
                </div>
            </div>
    ...
    <script>
        ...
        async function generatePDF(element, customOptions = {}) {
            try {
                ...
                const filename = `Mémoire-{{ $missionOrder->order_number }}-{{ $missionOrder->employee->first_name }}_{{ $missionOrder->employee->last_name }}.pdf`;
