...
{{-- @section('content')
    @include('vendor.mail.html.header', ['url'=> $url])

    <!-- Your custom content here -->
    <h1>Hello, {{ $user->employee->first_name }}!</h1>

    <p>This is a custom HTML email using Laravel's published components.</p>

    @component('vendor.mail.html.button', ['url' => $url, 'color' => 'primary'])
        Click Me
    @endcomponent
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{route('mission_orders.index')}}"
                                ...
                                <img src="{{ asset('/resources/images/logo-IFI.jpeg') }}"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            commandes quotidiennes {{ now()->format('d M Y') }}</h1>
                                        <p
                                            ...
                                            Bonjour {{ $user->employee->first_name }}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Veuillez consulter les commandes suivantes:</p>
                                        <table style="border: solid 1px;">
                                            @foreach ($notifications as $notification)
                                                <tr>
                                                    <td>{{ $notification['title'] }}</td>
                                                    <td>{{ $notification['body'] }}</td>
                                                    <td><a href="{{ $notification['link'] }}"
                                                            class="button button-primary" target="_blank" rel="noopener"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">{{ $notification['linkText'] }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </table>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2025 Mission-IFI. All rights reserved.</p>
