...
<div class="m-4">
        ...
        <div class="w-1/3 px-3">
            <div class="relative w-full h-full mx-auto">
                @if ($employee->profile_image)
                    <img class="w-1/2 h-auto object-cover" src="{{ asset('storage/public/' . $employee->profile_image) }}" alt="Profile Image" class="object-cover w-full h-full">
                @else
    ...
    <div class="relative z-0 mb-6 w-full group">
        ...
        <label for="department_id"
            class="peer-focus:font-medium absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 blue-color">{{ __('Secteur') }}</label>
    </div>
    <div class="relative z-0 mb-6 w-full group">
        ...
        @endif
        <label for="position"
            class="peer-focus:font-medium absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 blue-color">{{ __('Fonction') }}</label>
    </div>
    <div class="relative z-0 mb-6 w-full group">
