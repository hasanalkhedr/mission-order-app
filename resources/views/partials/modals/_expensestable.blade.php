    ...
    <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
        <div class="flex flex-col items-center">
            ...
            <div class="flex items-center justify-center">
                <span class="mr-2 font-medium">{{ $missionOrder->no_meals }}</span>
                <span class="mr-1">-</span>
                <input type="number" name="no_ded_meals" value="{{$missionOrder->no_ded_meals}}" min="0" max="{{ $missionOrder->no_meals }}"
                       class="reduced-meals-input w-16 px-2 py-1 border border-gray-300 rounded-md text-sm">
                <span class="ml-2 font-medium">= <span class="actual-meals">{{ $missionOrder->no_meals }}</span></span>
            </div>
        </div>
        <input type="hidden" id="max-meals" value="{{ $missionOrder->no_meals }}">
        <input type="hidden" id="meal-cost" value="{{ $missionOrder->bareme->meal_cost }}">
    </td>
...
<tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
    ...
    <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
        <div class="flex flex-col items-center">
            <span class="text-xs text-gray-500 mb-1">Réduire le nombre</span>
            <div class="flex items-center justify-center">
                <span class="mr-2 font-medium">{{ $missionOrder->no_accomodation }}</span>
                <span class="mr-1">-</span>
                <input type="number" name="no_ded_accomodation" value="{{$missionOrder->no_ded_accomodation}}" min="0"
                       class="reduced-accommodation-input w-16 px-2 py-1 border border-gray-300 rounded-md text-sm">
                <span class="ml-2 font-medium">= <span class="actual-accommodation">{{ $missionOrder->no_accomodation }}</span></span>
            </div>
        </div>
        ...
        <input type="hidden" id="accommodation-cost" value="{{ $missionOrder->bareme->accomodation_cost }}">
        <input type="hidden" id="original-accommodation" value="{{ $missionOrder->no_accomodation }}">
    </td>
    <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
