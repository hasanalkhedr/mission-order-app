                        ...
                        <tbody>
                            ...
                            <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800 reimbursement-amount"
                                    data-currency="INR"
                                    data-amount="{{ $tournee->no_meals * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                    {{ $tournee->no_meals * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}
                                </td>
                                <td
                                    class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
                                    INR
                            ...
                            <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
                                ...
                                <td
                                    ...
                                    <input type="hidden" id="max-accommodation"
                                        value="{{ $tournee->no_accomodation * $tournee->bareme->accomodation_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                ...
                                <td
                                    ...
                                    <input type="number" name="expenses[1][reimbursement_amount]"
                                        ...
                                        data-max="{{ $tournee->no_accomodation * $tournee->bareme->accomodation_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                </td>
                                <td
                                    class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
                                ...
                                <td
                                    ...
                                    <input type="hidden" name="expenses[1][total_inr]"
                                        value="{{ $tournee->no_accomodation * $tournee->bareme->accomodation_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                    <span
                                        class="total-inr">{{ $tournee->no_accomodation * $tournee->bareme->accomodation_cost / ($current_rate ? $current_rate->eur_rate : 1) }}</span>
                                </td>
                                <td
                                    class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
                            ...
                            @foreach ($tournee->expenses->where('type', 'extra_meal') as $expense)
                                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
                                    ...
                                    <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800 reimbursement-amount"
                                        data-currency="INR"
                                        data-amount="{{ ($expense->meal_participants ?? 0) * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                        {{ ($expense->meal_participants ?? 0) * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}
                                    </td>
                                    <td
                                        class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
                                        INR
                                    ...
                                    <td
                                        ...
                                        <input type="hidden" name="expenses[{{ $index }}][total_inr]"
                                            value="{{ ($expense->meal_participants ?? 0) * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
                                        <span
                                            class="total-inr">{{ ($expense->meal_participants ?? 0) * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}</span>
                                    </td>
                                    <td
                                        class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
                                        <div class="flex flex-col space-y-1">
...
@foreach ($tournee->expenses->where('type', 'extra_meal') as $expense)
    <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
        ...
        <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
            ...
            <input type="hidden" id="extra-meal-cost-{{ $index }}" value="{{ $tournee->bareme->meal_cost }}">
        </td>
        <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
            <input type="number" name="expenses[{{ $index }}][reimbursement_amount]"
                   ...
                   data-index="{{ $index }}"
                   data-max="{{ ($expense->meal_participants ?? 0) * $tournee->bareme->meal_cost / ($current_rate ? $current_rate->eur_rate : 1) }}">
        </td>
        <td class="px-3 py-2 text-center border border-gray-200 whitespace-nowrap text-sm text-gray-800">
